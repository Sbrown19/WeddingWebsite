...
//          CHANGE THE FOLLOWING INFORMATION TO SEND EMAIL FOR YOU //  
	...
	$toEmail = "skylerismeganithappen@gmail.com";		//will send the email to the email address entered on the form 
	...
	$fromEmail = "skylerismeganithappen@skylerismeganithappen.com";		//Change the email address within the quotes to be YOUR host server email address.  
